...
extern volatile unsigned int  LVDCON __attribute__((__sfr__));
__extension__ typedef struct tagLVDCONBITS {
  union {
    struct {
      unsigned LVDL:4;
      unsigned :1;
...
extern volatile LVDCONBITS LVDCONbits __attribute__((__sfr__));
...
extern volatile unsigned int  DSSEMA1 __attribute__((__sfr__));
extern volatile unsigned int  DSSEMA2 __attribute__((__sfr__));
...
/* LVDCON */
#define _LVDL LVDCONbits.LVDL
#define _IRVST LVDCONbits.IRVST
#define _BGVST LVDCONbits.BGVST
#define _VDIRMAG LVDCONbits.VDIRMAG
#define _LVDIDL LVDCONbits.LVDIDL
#define _LVDEN LVDCONbits.LVDEN
#define _LVDL0 LVDCONbits.LVDL0
#define _LVDL1 LVDCONbits.LVDL1
#define _LVDL2 LVDCONbits.LVDL2
#define _LVDL3 LVDCONbits.LVDL3

/* DSCON */
#define _DSSR DSCONbits.DSSR
#define _ZPBOR DSCONbits.ZPBOR
#define _DSEN DSCONbits.DSEN

/* DSWSRC */
#define _PORMV DSWSRCbits.PORMV
#define _MCLR DSWSRCbits.MCLR
#define _RTCC DSWSRCbits.RTCC
#define _DSWDT DSWSRCbits.DSWDT
#define _DSFLT DSWSRCbits.DSFLT
#define _INT0 DSWSRCbits.INT0

/* NVMCON */
#define _NVMOPSZ NVMCONbits.NVMOPSZ
#define _NVMSEL NVMCONbits.NVMSEL
#define _ERASE NVMCONbits.ERASE
#define _PGMONLY NVMCONbits.PGMONLY
#define _WRERR NVMCONbits.WRERR
#define _WREN NVMCONbits.WREN
#define _WR NVMCONbits.WR
#define _NVMOPSZ0 NVMCONbits.NVMOPSZ0
#define _NVMOPSZ1 NVMCONbits.NVMOPSZ1
#define _NVMSEL0 NVMCONbits.NVMSEL0
#define _NVMSEL1 NVMCONbits.NVMSEL1
#define _NVMSEL2 NVMCONbits.NVMSEL2
#define _NVMSEL3 NVMCONbits.NVMSEL3
...
**     BSS_BSS_2K_HI        High Security Boot Protect 000000 - 002BFE
**     BSS_BSS_1K_HI        High Security Boot Protect 000000 - 000AFE
**     BSS_BSS_2K_STD       Standard Security Boot Protect 000000 - 002BFE
**     BSS_BSS_1K_STD       Standard Security Boot Protect 000000 - 000AFE
**     BSS_OFF              Disabled
**
...
#define BSS_BSS_2K_HI        0xFFF3
#define BSS_BSS_1K_HI        0xFFF5
#define BSS_BSS_2K_STD       0xFFFB
#define BSS_BSS_1K_STD       0xFFFD
...
**
**   Standard Security General Segment:
**     GSS0_ON              Enabled
**     GSS0_OFF             Disabled
**
...
**     FNOSC_FRCDIV_PLL     Fast RC Oscillator With Postscaler + PLL Module (FRCDIV+PLL)
**     FNOSC_PRIMARY        Primary Oscillator (MS, HS, EC)
**     FNOSC_PRIMARY_PLL    Primary Oscillator with PLL Module (MS+PLL, HS+PLL, EC+PLL)
**     FNOSC_SECONDARY      Secondary Oscillator (SOSC)
...
#define FNOSC_FRCDIV_PLL     0xFFF9
#define FNOSC_PRIMARY        0xFFFA
#define FNOSC_PRIMARY_PLL    0xFFFB
#define FNOSC_SECONDARY      0xFFFC
#define FNOSC_LPRC           0xFFFD
#define FNOSC_LPFRCDIV       0xFFFE
...
**     POSCFREQ_MINKHZ      < 100kHz
**     POSCFREQ_100KHZ      100kHz - 8MHz
**     POSCFREQ_8MHZ        > 8MHz
**
**   OSCO/RC15 function:
**     OSCIOFNC_ON          RA3
...
#define POSCFREQ_MINKHZ      0xFFEF
#define POSCFREQ_100KHZ      0xFFF7
#define POSCFREQ_8MHZ        0xFFFF
...
**
**   Brown Out Voltage:
**     BORV_ZERO_POWER      Zero Power
**     BORV_2_7V            2.7V
**     BORV_2_0V            2.0V
**     BORV_1_8V            1.8V
**
**   I2C1 pins Select:
**     AI2C1SEL_SEC         Use Secondary I2C1 pins
**     AI2C1SEL_PRI         Use Primary I2C1 pins
**
**   Power Up Timer:
**     PWRTEN_OFF           Disabled
**     PWRTEN_ON            Enabled
...
#define BORV_ZERO_POWER      0xFF9F
#define BORV_2_7V            0xFFBF
#define BORV_2_0V            0xFFDF
#define BORV_1_8V            0xFFFF

#define AI2C1SEL_SEC         0xFFEF
#define AI2C1SEL_PRI         0xFFFF
...
**     COE_ON               Reset into Emulation Mode
...
#define _FDS(x) __attribute__((section("__FDS.sec,code"))) int _FDS = (x);
...
**     DSWDTEN_ON           Enabled
**
**   Deep Sleep Zero Power BOR:
**     DSBOR_OFF            Disabled
**     DSBOR_ON             Enabled
**
**   RTCC Reference Clock Select:
**     RTCCREF_OFF          Low Power RC Oscillator (LPRC)
**     RTCCREF_ON           Secondary Oscillator (SOSC)
**
**   Deep Sleep Watchdog Timer Clock Select:
**     DSWDTLPRC_OFF        Secondary Oscillator (SOSC)
**     DSWDTLPRC_ON         Low Power RC Oscillator (LPRC)
**
**   Deep Sleep Watchdog Postscale Select Bits:
**     DSWDTPS_DSWDTPS_0    2.1 Milliseconds
**     DSWDTPS_DSWDTPS_1    8.3 Milliseconds
**     DSWDTPS_DSWDTPS_2    33 Milliseconds
**     DSWDTPS_DSWDTPS_3    132 Milliseconds
**     DSWDTPS_DSWDTPS_4    528 Milliseconds
**     DSWDTPS_DSWDTPS_5    2.1 Seconds
**     DSWDTPS_DSWDTPS_6    8.5 Seconds
**     DSWDTPS_DSWDTPS_7    34 Seconds
**     DSWDTPS_DSWDTPS_8    135 Seconds
**     DSWDTPS_DSWDTPS_9    9 Minutes
**     DSWDTPS_DSWDTPS_A    36 Minutes
**     DSWDTPS_DSWDTPS_B    2.4 Hours
**     DSWDTPS_DSWDTPS_C    9.6 Hours
**     DSWDTPS_DSWDTPS_D    38.5 Hours
**     DSWDTPS_DSWDTPS_E    6.4 Days
**     DSWDTPS_DSWDTPS_F    25.7 Days
**
*/
...
#define DSBOR_OFF            0xFFBF
#define DSBOR_ON             0xFFFF

#define RTCCREF_OFF          0xFFDF
#define RTCCREF_ON           0xFFFF

#define DSWDTLPRC_OFF        0xFFEF
#define DSWDTLPRC_ON         0xFFFF

#define DSWDTPS_DSWDTPS_0    0xFFF0
#define DSWDTPS_DSWDTPS_1    0xFFF1
#define DSWDTPS_DSWDTPS_2    0xFFF2
#define DSWDTPS_DSWDTPS_3    0xFFF3
#define DSWDTPS_DSWDTPS_4    0xFFF4
#define DSWDTPS_DSWDTPS_5    0xFFF5
#define DSWDTPS_DSWDTPS_6    0xFFF6
#define DSWDTPS_DSWDTPS_7    0xFFF7
#define DSWDTPS_DSWDTPS_8    0xFFF8
#define DSWDTPS_DSWDTPS_9    0xFFF9
#define DSWDTPS_DSWDTPS_A    0xFFFA
#define DSWDTPS_DSWDTPS_B    0xFFFB
#define DSWDTPS_DSWDTPS_C    0xFFFC
#define DSWDTPS_DSWDTPS_D    0xFFFD
#define DSWDTPS_DSWDTPS_E    0xFFFE
#define DSWDTPS_DSWDTPS_F    0xFFFF
